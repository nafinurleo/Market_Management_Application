...
namespace Market_Management
{
    public partial class Form1 : Form
    {
        ...
        {    
            ...
            SqlConnection connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Fifth Semester\OOP2\Project Work\Project Code\market_management(project)\market_management\MarketDATABASE.mdf;Integrated Security=True;Connect Timeout=30");
...

            {
                ...
                try
                {
                    if (CatCB.SelectedItem.ToString() == "SELLER")
                    {
                        ...
                        {
                            MessageBox.Show("Don't Have Any Account. \n PLEASE signup or input right info.");
